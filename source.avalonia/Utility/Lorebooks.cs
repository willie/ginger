...
{
	/// <summary>
	/// Static manager for loading and browsing lorebooks from the Content directory.
	/// </summary>
	public static class Lorebooks
	{
		...
		/// <summary>
		/// Load all lorebooks from the Content/Lorebooks directory.
		/// </summary>
		public static void LoadLorebooks()
		{
			...
			if (!Directory.Exists(lorebookPath))
				return;
			...
			for (int i = 0; i < csvFiles.Length; ++i)
			{
				...
				{
					filename = csvFiles[i],
					paths = Utility.SplitPath(Utility.GetSubpath(lorebookPath, csvFiles[i]) ?? ""),
				};
		...
		/// <summary>
		/// Get all subfolder names at a given path.
		/// </summary>
		...
		/// <summary>
		/// Get all lorebooks in a specific folder.
		/// </summary>
